...
- [X] [/pipeline-promotions/{pipeline_promotion_id}/promotion-targets](https://devcenter.heroku.com/articles/platform-api-reference#pipeline-promotion-target-list)
